...
parser.add_argument('--data_dir', default='/s/bach/a/class/cs435/cs435g/data/HR/cnn_output', help="Directory containing the dataset")
parser.add_argument('--model_dir', default='/s/bach/a/class/cs435/cs435g/srcnn/training', help="Directory containing params.json")
