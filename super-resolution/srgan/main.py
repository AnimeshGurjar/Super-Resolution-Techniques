...
parser.add_argument("--LR_path", type = str, default = '/s/bach/a/class/cs435/cs435g/data/Low')
parser.add_argument("--HR_path", type = str, default = '/s/bach/a/class/cs435/cs435g/data/High')
